...
navMenu.id = 'nav-menu';
const navLinks = [
    { href: '../header/aboutMe.html', text: 'About Me', class: 'about-me-link' }, // Add a class for About Me
    { href: '../header/resume.html', text: 'Resume' },
    { href: '../header/project.html', text: 'Projects' },
    { href: '../header/contact.html', text: 'Contact' },
];
...
resumeButton.href = '../header/resume.html'; // Navigate to Resume page
...
projectButton.href = '../header/project.html'; // Navigate to Projects page
